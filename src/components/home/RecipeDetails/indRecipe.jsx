            ...
            <p
              ...
              {isRecipeVisible && (
                ...
                isRecipeVisible={isRecipeVisible}
                 ...
                 dialogueText={" Recipe Deleted successfully"} linkTo={"/"} />              
              )}
   {/**Ingredients */}         
  ...
  {indRecipe.ingredients.map((ingredient, index) => (
    ...
    >
      {ingredient}
              ...
              <p className="text-gray-700 dark:text-text italic lg:my-5 my-3">{indRecipe.making}</p>
            </div>
      ...
      {/* Other recipe details */}
         ...
         <div
          className="text-3xl text-yellow-500 text-center p-10"
        >Something went wrong  please reload</div> }
      </section>    
    </div>
  );
}
